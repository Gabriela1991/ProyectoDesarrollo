...
<meta charset="utf-8">
<link rel="stylesheet" href="../Web Application/css/reset.css" type="text/css" media="all">
<link rel="stylesheet" href="../Web Application/css/layout.css" type="text/css" media="all">
<link rel="stylesheet" href="../Web Application/css/style.css" type="text/css" media="all">
<script type="text/javascript" src="../Web Application/js/jquery-1.4.2.js" ></script>
<script type="text/javascript" src="../Web Application/js/cufon-yui.js"></script>
<script type="text/javascript" src="../Web Application/js/cufon-replace.js"></script> 
<script type="text/javascript" src="../Web Application/js/Butter_500.font.js"></script>
<!--[if lt IE 9]>
