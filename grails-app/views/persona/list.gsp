			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="clavedropbox" title="${message(code: 'persona.clavedropbox.label', default: 'Clavedropbox')}" />
				...
				<g:each in="${personaInstanceList}" status="i" var="personaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personaInstance, field: "clavedropbox")}</td>
